...
| §2 动作生成范式 | 102-141 | 按需 | — |
| §3 训练范式 | 143-191 | 跳过 | — |
| §4 信念网络 ★ | 193-231 | **必读** | `docs/system/BELIEF_GRAPH.md`（完整变化历史） |
| §5 收敛地图 ★ | 233-307 | **必读** | — (本文已是最完整版本) |
| §6 触觉 | 309-333 | 跳过 | `theory/tactile/` + `theory/frontier/tactile_*` |
| §7 部署 | 335-382 | 按需 | `deployment/` |
| §8 产业 | 384-446 | 按需 | `companies/` + `memory/blog/archives/vla-social-intel/` |
| §9 当前状态 ★ | 448-538 | **必读** | `reports/weekly/` 或 `reports/biweekly/` 最新 |
| §10 深度专题 | 540-628 | 按需 | `theory/frontier/` 对应论文 |
| §11 论文速查 | 630-804 | 按需 | — |
| §12 开源基础设施 | 806-821 | 按需 | — |
| §13 产品与市场 | 823-829 | 跳过 | — |
| §14 高频面试要点 | 831-866 | 按需 | — |
| §15 校准纪律 ★ | 868-877 | **必读** | — |
...
6. **本文档截止日期**：2026-05-07，VLA 领域每周都有重大变化

---

*生成自 KW_VLA Handbook v3 | 332+ 篇源文件 → ~16K tokens 压缩索引 | 定时任务每日 09:00 增量更新 | v2.0.16 2026-05-07 (scheduled task run, high-density catch-up day — 05-06 paper-scan v3.6.2 + convergence-radar v3.6.3 BOTH delayed-arrival integrated; today 05-07 again zero-new-data; BELIEF_GRAPH.md at v3.6.3-convergence-radar; no confidence changes but accumulation pressure significant; Phase counters synced [Phase 1 13/15 + 13 anti-phase / Phase 2 22/15 / Phase 4 28/12 / Phase 5 17/12 / Phase 5 cand. 4/15 / 🆕 Phase 6 cand. TTC 1/15]; B4 sub-routes 4→6 (+RoboAlign-R1 reward-aligned WM 6th cross-Phase 4×2); new windows #9 dual-system inference acceleration ~3-6mo + #10 frontier open data + recipe ~6-12mo; new prediction #23 VLA-TTC 3rd-party signal due 2026-08-06; conservative bias counters +1d (B0=20d, B1=3d, B2=3d, B3=3d, B4=13d, B5=37d 🔴 13 anti-phase 2 from threshold, B6=63d 🔴 nearing 67d ceiling reflection threshold, B7=8d, B8=51d 🔴, B9=22d); arxiv top-lab silence at day 36, history max +14d; paradigm shift candidate 'VLA engineering deployment narrative' 35-40% prior; Source Map updated for line shifts)*
